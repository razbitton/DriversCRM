...
export default function NewDeliveryModal({ setOpen, onDeliveryCreated }: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const tenderData: InsertTender = {
        ...
        channel_id: formData.channel_id === 'all_channels' ? null : parseInt(formData.channel_id),
    };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <footer className="modal-footer">
              ...
              <Button type="submit" className="btn btn-save" disabled={createTenderMutation.isPending}>
                {createTenderMutation.isPending ? "יוצר..." : "צור שליחות חדשה"}
              </Button>
          </footer>
        </form>
      </div>
